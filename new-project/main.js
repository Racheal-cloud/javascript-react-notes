...
import "../todo-app/utils/bling.js";
...
// childNodes - firstChilst -lastChild - nextSiblings - previousSiblings
...
// let app = 5
// console.log(app)
// querySelectorAll('css selectors') - it takes the string of css selector, help to select a particular element and returns a NodeList
// querySelector('css selectors') - it takes the string of css selector and returns the first element that matches the selector

// what is the difference between a NodeList, an HTMLCollection and a live collection.
